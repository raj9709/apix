      ...
      <div className="w-full space-y-6">
        <header className="flex justify-between items-center bg-slate-900 border border-slate-800 p-4 rounded-xl shadow-sm">
          <div>
            ...
            <p className="text-sm text-slate-400">MoSPI Airfare Price Index</p>
          </div>
          <button
            onClick={handleRunNow}
            disabled={loading}
            className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 transition-colors text-white rounded-lg font-medium shadow-lg shadow-indigo-900/20 disabled:opacity-50 disabled:cursor-not-allowed"
          >
